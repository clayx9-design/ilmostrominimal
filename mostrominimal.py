...
# ------------------------------------------------------------
# Il Mostro 5.0 - v7 (Tema Giallo/Rosso + Fix Mobile + Esclusione Giocatore)
# ------------------------------------------------------------
...
def main():
    ...
    if not st.session_state['combined_results'].empty:
        ...
        # Summary Card (Mobile-Friendly: stacked metrics)
        ...
        # Le metriche sono visualizzate in pila per la leggibilità su mobile
        ...
        # Mostra la classifica e i pulsanti di esclusione (nascondendo Risk e Prob %)
