...
# -------------------------
# CSS (TEMA MIGLIORATO PER CONTRASTO)
# -------------------------
st.markdown("""
<style>
/* Base Theme */
/* Sfondo dell'app: Grigio molto chiaro per migliorare il contrasto con gli elementi bianchi */
...
def load_excel(source):
    ...
    try:
        # A causa della dipendenza openpyxl non trovata, assicuriamo che sia installata tramite requirements.txt
        ...
        # Controlla la dipendenza openpyxl
...
def main():
    ...
    with st.sidebar:
        ...
        # Tentativo di caricamento automatico dal file locale (utile su Streamlit Cloud)
        ...
        # Opzione di upload manuale se il file non è trovato o caricamento fallisce
...
if __name__ == '__main__':
    main().small-muted { color: #6b7280; font-size: 1.1rem; text-align: center; margin-bottom: 30px;} 
.stButton>button { 
    border-radius: 8px; 
    font-weight: bold;
    border: 1px solid #0b3d91;
